      ...
      <div className="glass-card p-12 w-full max-w-md text-center">
        ...
        <div className="space-y-4 text-left">
          <div>
            ...
            <input type="email" placeholder="name@example.com" className="w-full bg-white/5 border border-white/10 p-3 rounded-lg text-white focus:outline-none focus:border-accent/50" />
          </div>
          <div>
            <label className="text-xs uppercase tracking-widest text-accent mb-2 block">Password</label>
            <input type="password" placeholder="••••••••" className="w-full bg-white/5 border border-white/10 p-3 rounded-lg text-white focus:outline-none focus:border-accent/50" />
          </div>
        </div>
        
        <button className="w-full btn-gold mt-8">Login</button>
        ...
        <button className="w-full glass mt-6 py-3 text-sm flex items-center justify-center gap-2 hover:bg-white/10 transition-colors">
